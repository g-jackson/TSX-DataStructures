...
// helper.cpp
//
// Copyright (C) 2011 - 2014 jones@scss.tcd.ie
//
...
// for 32bit exes, make sure WinRing0.dll and WinRing0.sys or WinRing0x64.sys (for 32 and 64 bit winodws repspectively) are placed in the same directory
